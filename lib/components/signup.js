...
const redirectToLogin = (container) => {
  /* Location login */
  const loginRedirect = container.querySelector('#loginRedirect');
...
export const signUp = () => {
  ...
  // container.appendChild(succesfulSignUpModal('hola@a.com'));
  // container.appendChild(emailAlreadyExistsModal('hola@a.com'));
  return container;
};
