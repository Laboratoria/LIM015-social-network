import { sendPasswordResetEmail } from '../firebase/functions.js';
import { sendPasswordResetEmailModal } from './modal.js';
...
const resetPasswordFirebase = (container) => {
  ...
  resetBtn.addEventListener('click', (e) => {
    ...
    if (email.value !== '') {
      ...
      sendPasswordResetEmail(email[0].value)
        .then(() => {
          container.appendChild(sendPasswordResetEmailModal(email[0].value));
